    ...
    valid_tests = dict(
        ...
        complex=[
            (
                dict(
                    fit=dict(
                        eval_metric=Categorical(['auc', 'rmse', 'mae'], transform='onehot', name='eval_metric'),
                ...
                [
                    (('fit', 'eval_metric'), Categorical(['auc', 'rmse', 'mae'], transform='onehot', name='eval_metric'))
                ]
            ),
            (
                dict(
                    ...
                    predict=dict(
                        ...
                        some_other_dict=dict(
                            another_param=Real(0.1, 0.7, name='another_param')
                        )
                    )
                ),
                [
                    (('fit', 'eval_metric'), Categorical(['auc', 'rmse', 'mae'], transform='onehot', name='eval_metric')),
                    (('predict', 'some_other_dict', 'another_param'), Real(0.1, 0.7, name='another_param'))
                ]
            )
        ]
    )
