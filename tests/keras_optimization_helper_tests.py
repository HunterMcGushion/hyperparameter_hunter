...
def _build_fn_source_0(stage):
    ...
    if stage == 'original':
        ...
        return build_str.format(*[_[1] for _ in stage_vals], 'build_fn(input_shape=(10, ), params=None)')
...
class TestFindSpaceFragments(TestCase):
    valid_fragment_tests = dict(
        simple=[
            (_build_fn_source_0('original'), [  # TODO: Update below to leverage `_expected_params_0`, plus index numbers
                ...
                ["Categorical(['categorical_crossentropy', 'binary_crossentropy'])", 'loss', 533],
                ["Categorical(['rmsprop', 'adam', 'sgd'], transform='onehot')", 'optimizer', 647]
            ]),
            (_build_fn_source_1('original'), [  # TODO: Update below to leverage `_expected_params_1`, plus index numbers
                ...
                ["Categorical(categories=['three', 'four'])", 'Dropout_2', 676],  # FLAG: This is weird, but probably ok, maybe
                ["Categorical([Dropout(0.5), Activation('linear')])", 'add', 777],  # TODO: Layer selection not fully supported
                ["Categorical(['categorical_crossentropy', 'binary_crossentropy'])", 'loss', 970],
                ["Categorical(['rmsprop', 'adam', 'sgd'], transform='identity')", 'optimizer', 1086]
            ]),
        ]
    )
    ...
    valid_layers_tests = dict(
                ...
                [
                    {
                        ...
                        "arg_vals": {"units": 100},
                        "kwarg_vals": {
                            "activation": "relu", "use_bias": True, "kernel_initializer": "uniform", "bias_initializer": "zeros",
                    ...
                    },
                    {
                        ...
                        "arg_vals": {"units": 1},
                        "kwarg_vals": {
                            "activation": "sigmoid", "use_bias": True, "kernel_initializer": "uniform",
                ...
                [
                    {
                        "Dense": {
                            "arg_vals": {"units": 100},
                            "kwarg_vals": {
                                "activation": "relu", "use_bias": True, "kernel_initializer": "uniform",
                                "bias_initializer": "zeros",
                                "kernel_regularizer": None, "bias_regularizer": None, "activity_regularizer": None,
                                "kernel_constraint": None, "bias_constraint": None,
                            },
        ...
        separate_args_false=[
            (
                ...
                [
                    {
                        "class_name": "Dense", "units": 100, "activation": "relu", "use_bias": True,
                        "kernel_initializer": "uniform", "bias_initializer": "zeros", "kernel_regularizer": None,
                        "bias_regularizer": None, "activity_regularizer": None, "kernel_constraint": None,
                        "bias_constraint": None,
                    },
                    {"class_name": "Dropout", "rate": 0.5, "noise_shape": None, "seed": None},
                    {
                        "class_name": "Dense", "units": 1, "activation": "sigmoid", "use_bias": True,
                        "kernel_initializer": "uniform", "bias_initializer": "zeros", "kernel_regularizer": None,
        ...
        both_false=[
            (
                ...
                [
                    {
                        "Dense": {
                            "units": 100, "activation": "relu", "use_bias": True, "kernel_initializer": "uniform",
                            "bias_initializer": "zeros", "kernel_regularizer": None, "bias_regularizer": None,
                            "activity_regularizer": None, "kernel_constraint": None, "bias_constraint": None,
                        }
                    },
                    {
                        "Dropout": {
                            "rate": 0.5, "noise_shape": None, "seed": None
                        },
                    },
                    {
                        "Dense": {
                            "units": 1, "activation": "sigmoid", "use_bias": True, "kernel_initializer": "uniform",
                            "bias_initializer": "zeros", "kernel_regularizer": None, "bias_regularizer": None,
                            "activity_regularizer": None, "kernel_constraint": None, "bias_constraint": None
                        }
                    }
        ...
        simple=[
            ...
            (
                ...
                {'compile_kwargs': {},
                 ...
                 'optimizer': 'Adam',
                 'optimizer_params': {
                     'amsgrad': False, 'beta_1': 0.9, 'beta_2': 0.999, 'decay': 0.0, 'epsilon': 1e-07,
                     'lr': Real(0.0001, 0.1)},
                 'sample_weight_mode': None,
                 'target_tensors': None,
                 'weighted_metrics': None},
